...
**Snike** es una versión personalizada del clásico juego de la serpiente, desarrollada en **Python** utilizando **Pygame**.

Incluye sprites personalizados, música, animaciones, pantalla de guía y detección de colisiones.
